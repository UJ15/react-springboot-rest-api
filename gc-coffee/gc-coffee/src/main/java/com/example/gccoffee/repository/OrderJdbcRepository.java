...
public class OrderJdbcRepository implements OrderRepository{
    ...
    private Map<String, Object> orderToParamMap(Order order) {
        ...
        paramMap.put("address", order.getAddress().toString());
    ...
    private Map<String, Object> orderItemToParamMap(UUID orderId, LocalDateTime createdAt, LocalDateTime updatedAt, OrderItem item) {
        var paramMap = new HashMap<String, Object>();
